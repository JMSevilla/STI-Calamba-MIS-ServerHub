...
namespace sti_sys_backend.Migrations
{
    ...
    [Migration("20230927103437_accounts_add_required_time_inout")]
    partial class accounts_add_required_time_inout
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("sti_sys_backend.Models.Accounts", b =>
                {
                    ...
                    b.Property<TimeSpan?>("required_time_in")
                        .HasColumnType("time");

                    b.Property<TimeSpan?>("required_time_out")
                        .HasColumnType("time");
